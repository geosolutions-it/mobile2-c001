...
var {changeLocateState, onLocateError} = require('../../MapStore2/web/client/actions/locate');

var {changeMapView, clickOnMap, changeMousePointer} = require('../../MapStore2/web/client/actions/map');

var changeMeasurementState = require('../../MapStore2/web/client/actions/measurement');

var VMap = require('../../MapStore2/web/client/examples/viewer/components/Map');
